<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerRegister.aspx.cs" Inherits="LoyatyPointSystem.Views.CustomerRegister" %>
<!DOCTYPE html>
<html lang="en">
...
<body class="bg-dark">
    <div class="container">
        <div class="card card-register mx-auto mt-5">
            <div class="card-header">Customer Register an Account</div>
            <div class="card-body">
                <form runat="server">
                    ...
                    <div class="form-group">
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                ...
                                <asp:TextBox ID="txtEmail" runat="server" PlaceHolder="Email Address" CssClass="form-control" Height="34px" onfocusout="ValidatePassword(this);"></asp:TextBox>
                    ...
                    <asp:Button ID="btnCustomerRegister" runat="server" Text="Register" class="btn btn-primary btn-block" OnClick="btnRegisterCustomer_ServerClick" />
                    <i><a href="ViewAllCustomers.aspx">Home Page</a></i>
